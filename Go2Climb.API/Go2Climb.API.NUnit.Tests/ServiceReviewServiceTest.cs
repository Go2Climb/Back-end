...
namespace Go2Climb.API.NUnitTests
{
    public class ServiceReviewServiceTest
    {
        ...
        public async Task ListAsyncWhenNoServiceReviewReturnsEmptyCollection()
        {
            ...
            var service = new ServiceReviewService(mockServiceReviewRepository.Object, mockCustomerRepository.Object, mockServiceRepository.Object, mockUnitOfWork.Object);
        ...
        public async Task SavingWhenErrorReturnException()
        {
            ...
            //Assert
            message.Should().Contain("Customer does not exist");
        }
