...
namespace Go2Climb.API.Persistence.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Customer>().Property(p => p.PasswordHash).IsRequired().HasMaxLength(25);
            ...
            (
                new Customer { Id = 1, Name = "Heber", LastName = "Cordova Jimenez", Email = "hbcord@gmail.com", PasswordHash = "12345", PhoneNumber = "902952757", Photo = "https://i.pinimg.com/originals/57/67/51/5767513a0191633112d3f123b3931ab6.png"},
                new Customer { Id = 2, Name = "Maria", LastName = "Cordova Jimenez", Email = "iepv@gmail.com", PasswordHash = "67890", PhoneNumber = "931015430", Photo = "https://64.media.tumblr.com/ab66cb6480d6fd36fdffbf0e76c0d706/02ec740286bff118-3b/s1280x1920/1660382d542f1cf1902bcf284fab342c44291708.png"},
                new Customer { Id = 3, Name = "Celia", LastName = "Jimenez Garcia", Email = "celia@gmail.com", PasswordHash = "12345", PhoneNumber = "977453221", Photo = "https://64.media.tumblr.com/da0f572d2a8c2d081185b443c5552c7b/9d6ea44a3722ffa2-bd/s1280x1920/0f0486280de0e7979f5482f176c2daa1edfd4a41.jpg" },
                new Customer { Id = 4, Name = "Alejandro", LastName = "Jacobo", Email = "alej@outlook.es", PasswordHash = "#o9L2TtFd", PhoneNumber = "985389026", Photo = "https://i.pinimg.com/736x/29/52/d7/2952d7689d9f57747800fc3547c3b263.jpg" },
                new Customer { Id = 5, Name = "Rem", LastName = "Milla", Email = "rem@hotmail.com", PasswordHash = "R3mbest0waif%", PhoneNumber = "952684755", Photo = "https://64.media.tumblr.com/12642d704d69eb217bd5f388f5e55688/4565013b9e16e009-ec/s500x750/da633f0ba17116f35c0f627ff6ddc44c3568bf84.png" }
            );
